...
public class Jeep {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Available Jeep");
		...
		Image img5 = new ImageIcon(this.getClass().getResource("/Jeep2.jpeg")).getImage();
		...
		lblNewLabel_2_2.setIcon(new ImageIcon(img5));
		...
		lblNewLabel_2_3.setIcon(new ImageIcon(img5));
		...
		lblNewLabel_2_4.setIcon(new ImageIcon(img5));
		...
		lblNewLabel_2_4_1.setIcon(new ImageIcon(img5));
