...
public class Guestview2  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Guestview2 window = new Guestview2();
	...
	private void initialize() {
		...
		ImageIcon imageIcon = new ImageIcon(GuestVIEW.image);
		...
		JLabel lblNewLabel_2_1_1_11 = new JLabel(GuestVIEW.vehicle_name);
		...
		JLabel lblNewLabel_2_1_1_1_1 = new JLabel("Price :  " +GuestVIEW.Price);
		...
		JLabel lblNewLabel_2_1_1_1_1_1 = new JLabel("Displacement : " +  GuestVIEW.Displacement);
		...
		JLabel lblNewLabel_2_1_1_1_1_2 = new JLabel("Mileage:  " + GuestVIEW.mileage);
		...
		JLabel lblNewLabel_2_1_1_1_1_2_1 = new JLabel("Fuel Capacity : "  + GuestVIEW.Fuel_Capacity);
		...
		JLabel lblNewLabel_2_1_1_1_1_2_1_1 = new JLabel("Company Name : " +  GuestVIEW.Company_Name );
		...
		if(GuestVIEW.Status .equals("Booked")) {
			btnNewButton.setEnabled(false);
		}
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "Please log in !!!", "INfO", JOptionPane.INFORMATION_MESSAGE);
		...
		JLabel lblNewLabel_2_1_1_1_1_2_1_1_1_1 = new JLabel("Status : "  + GuestVIEW.Status     );
		...
		JLabel lblNewLabel_2_1_1_1_1_3 = new JLabel(GuestVIEW.vehicle_number);
		...
		lblNewLabel_2_1_1_1_1_2_1_1_1_1_1.setBounds(755, 464, 474, 29);
